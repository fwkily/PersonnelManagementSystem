...
<script language="javascript" type="text/javascript">
  ...
  function link(){
  if(document.fom.idcard.value=="" && document.fom.id.value==""){
	alert("您必须选择一项！");
	return false;
}
if(document.fom.idcard.value.length==""||document.fom.idcard.value.length=='18'&&document.fom.id.value.length>0){
...
<body>
<div id="man_zone">
  <form action="${pageContext.request.contextPath}/info/queryInfo" onsubmit="return link();"  method="post" name="fom" id="fom" target="manFrame" >
    <div class="MainDiv">
          ...
          <td class="CPanel"><table width="99%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
            ...
            <tr bgcolor="#EEEEEE">
              <td colspan="16" align="center"><div align="center">
                ...
                <p>
                  <label>身份证号：
                    <input type="text" name="idcard" value="${skemp.idcard}"/>
                    </label>
                </p>
                <p>员工编号：
                  <input type="text" name="id" value="${skemp.id} "/>
                </p>
              </div>
