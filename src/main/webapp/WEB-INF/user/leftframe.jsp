...
document.write("<script src='${pageContext.request.contextPath}/js/nav.js' charset='utf-8'></" + "script>");
</script>
<body onload="initinav('组织管理')">
<div id="left_content">
  <div id="user_info">欢迎您,${manager.name}<br />  
       <span class="STYLE2">
       <!-- #BeginDate format:fcCh2m -->2012年4月04日 星期三  <!-- #EndDate -->
     </span></div>
  <div id="main_nav">
